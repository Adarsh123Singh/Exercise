    ...
    <div class="container">
        <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <label for="recipient-name" class="col-form-label">Change Image</label>
                    ...
                    <img src="<?php echo $result['img_post']; ?>"n value="Change Image">
                </div>
                <div class="mb-3">
...
if ($BOOKNAME !="" && $BOOKTITLE !="" && $AUTHERNAME !=="" && $NUMBER !="" && $BOOKTYPE !="" && $BOOKADDITION !="" && $DESCRIPTION !="") {
    ...
    $query = "UPDATE edit SET img_post='$folder', BOOKNAME='$BOOKNAME',BOOKTITLE='$BOOKTITLE',AUTHERNAME='$AUTHERNAME',NUMBER='$NUMBER', BOOKTYPE='$BOOKTYPE',BOOKADDITION='$BOOKADDITION',DESCRIPTION='$DESCRIPTION' WHERE id='$id'";
    $data = mysqli_query($con,$query);
    var_dump($data);
    if ($data) {
