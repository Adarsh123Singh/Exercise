...
<body>
    <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <a href="userdeatils.php"><button type="button" class="btn btn-outline-light">User Details</button></a>
        </div>
    </nav>
    <div class="con">
    ...
    <center>
        ...
        while ($result = mysqli_fetch_assoc($data)) {
            echo "<tr>
                    ...
                    <a href='#'><input type='checkbox' checked<span class='slider round'></span></a>
                    </td>
                </tr>";
